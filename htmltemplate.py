...
<div class="chat-message bot">
    <div class="avatar">
        <img src="https://img.freepik.com/vecteurs-libre/vectorart-robot-style-dessin-anime_78370-4103.jpg?semt=ais_hybrid&w=740" style="max-height: 78px; max-width: 78px; border-radius: 50%; object-fit: cover;">
    </div>
